      ...
      try {
        ...
        if (res.ok) {
          ...
          setFormData({
            ...
            brand: data.brand || '',
            sizeTag: data.sizeTag || '',
            condition: data.condition || '',
            yearEstimate: data.yearEstimate || '',
            color: data.color || '',
            ...
            pitToPit: data.measurement?.pitToPit?.toString() || '',
            length: data.measurement?.length?.toString() || ''
          })
          setHasSale(Boolean(data.sale))
        } else {
    ...
    <div className="max-w-4xl mx-auto">
      <div className="mobile-page-header mb-6">
        ...
        <div className="mobile-action-row">
          ...
          <DeleteItemButton itemId={parseInt(params.id)} hasSale={hasSale} />
        </div>
      </div>
